...
export interface PantheonRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admin"
      | "allocator"
...
export interface PantheonRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): PantheonRegistry;
  waitForDeployment(): Promise<this>;

  interface: PantheonRegistryInterface;
